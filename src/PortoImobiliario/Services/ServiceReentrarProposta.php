...
/**
 * Class ServiceReentrarProposta
 * @package MatheusHack\PortoImobiliario\Services
 */
class ServiceReentrarProposta extends Client implements ServiceInterface
{
    /**
     * @param $request
     * @return mixed|void
    ...
    {
        try{
            $response = parent::__soapCall('reentrarProposta',$request);
