...
abstract class Client extends \SoapClient
{
    ...
    public function __construct($wsdl)
    {
        ...
        parent::__construct($wsdl, [
            'login' => getenv('PORTO_IMOBILIARIA_USERNAME'),
            'password' => getenv('PORTO_IMOBILIARIA_PASSWORD'),
            'exceptions' => true,
            'trace' => true,
            ...
            'stream_context' => stream_context_create([
                'header' => [
                    'Authorization: '.base64_encode(getenv('PORTO_IMOBILIARIA_USERNAME').":".getenv('PORTO_IMOBILIARIA_PASSWORD'))
                ]
            ])
        ]);
    }
